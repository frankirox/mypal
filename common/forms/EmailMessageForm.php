                ...
                if (is_array($this->attachment)) {
                    ...
                    foreach ($this->attachment as $attachment) {
                        ...
                        if (is_array($attachment)) {
                            ...
                            if (array_key_exists('content', $attachment) && array_key_exists('fileName',
                                    $attachment) && array_key_exists('contentType', $attachment)
                            ) {

                                $emailMessage->attachContent($attachment['content'],
                                    ['fileName' => $attachment['fileName'], $attachment['contentType']]);
                            }
                        }
