...
abstract class AbstractItem extends ActiveRecord
{
    ...
    {
        return Yii::$app->miranda->auth_item_table;
    }
    ...
    {
        return parent::find()->andWhere([Yii::$app->miranda->auth_item_table . '.type' => static::ITEM_TYPE]);
    }
    ...
    {
        return [
            'name' => Yii::t('miranda', 'Code'),
            'description' => Yii::t('miranda', 'Description'),
            'rule_name' => Yii::t('miranda', 'Rule'),
            'group_code' => Yii::t('miranda', 'Group'),
            'data' => Yii::t('miranda', 'Data'),
            'type' => Yii::t('miranda', 'Type'),
