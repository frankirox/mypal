...
class Upload
{
    ...
    {
        $uploadPath = Yii::getAlias('@storage') . DIRECTORY_SEPARATOR . self::$UPLOADS_DIR . ($dir ? DIRECTORY_SEPARATOR . $dir : '');
    ...
    static function getLink($fileName)
    {
        ...
        return str_replace('\\', '/', str_replace(Yii::getAlias('@storage'), '/storage', $fileName));
    }
