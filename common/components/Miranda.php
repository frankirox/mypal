...
/**
 * MirandaCMS component. Contains basic settings and functions of MirandaCMS.
 */
class Miranda extends Component
{

    /**
     * Version number of the component.
     */
    const VERSION = '2017.6.7';
    ...
    /**
     * Enable or Disable the language caching
     *
     * @var bool
     */
    public $languageEnableCaching = true;

    /**
     * Language caching duration in seconds
     *
     * @var int
     */

    public $languageCachingDuration = 3600;
    ...
    /**
     * Register MirandaCMS DB message translations.
     */
    protected function registerTranslations()
    {
        Yii::$app->i18n->translations['miranda*'] = [
            'class' => 'common\db\DbMessageSource',
            'sourceLanguage' => 'en-US',
            'enableCaching' => $this->languageEnableCaching,
            'cachingDuration' => $this->languageCachingDuration,
        ];
    }
    ...
    protected function initLanguageOptions()
    {
        if (empty($this->languages) || !is_array($this->languages)) {
            $this->languages[Yii::$app->language] = Yii::t('miranda', 'Default Language');
        }
    ...
    public function getSourceLanguageShortcode($language)
    {
        ...
        $languageRedirects = array_flip(Yii::$app->miranda->languageRedirects);
    ...
    {
        return '<div style="display: block; text-align: center"><small>Miranda CMS, Open Source Content Management System Based on Yii Framework 2.</small></div>';
    }
