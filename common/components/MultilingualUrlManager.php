...
abstract class MultilingualUrlManager extends UrlManager
{
    ...
    public function createUrl($params)
    {
        ...
        if (Yii::$app->miranda->isMultilingual && !empty($this->multilingualRules)) {
            $languages = array_keys(Yii::$app->miranda->displayLanguages);
            ...
            if (!isset($params['language'])) {
                ...
                $params['language'] = Yii::$app->miranda->getDisplayLanguageShortcode(Yii::$app->language);
            }
        }
    ...
    {
        $rules = $this->rules;
        $prefix = Yii::$app->miranda->isMultilingual ? $this->languagePattern . '/' : '';
