...
namespace backend\actions; //common\web;
...
class DashboardAction extends Action
{
    ...
    public function run()
    {
        $this->controller->getView()->title = Yii::t('miranda', 'Dashboard');

        if (!is_array($this->widgets)) {
            throw new NotFoundHttpException(Yii::t('miranda', 'Invalid settings for dashboard widgets.'));
        }
