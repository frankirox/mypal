...
use backend\assets\MirandaAsset;
...
$assetBundle = MirandaAsset::register($this);
...
<div class="wrap">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        if (Yii::$app->user->isGuest) {
            $menuItems[] = ['label' => Yii::t('miranda', 'Login'), 'url' => ['/auth/login']];
        } else {
            $menuItems[] = [
                'label' => Yii::t('miranda', 'Logout {username}', ['username' => Yii::$app->user->identity->username]),
