...
class GridQuickLinks extends Widget
{
    ...
    public function init()
    {
        ...
        if (!$this->defaultOptions) {
            $this->defaultOptions = [
                'all' => ['label' => Yii::t('miranda', 'All'), 'filterWhere' => []],
                'active' => ['label' => Yii::t('miranda', 'Active'), 'filterWhere' => ['status' => 1]],
                'inactive' => ['label' => Yii::t('miranda', 'Inactive'), 'filterWhere' => ['status' => 0]],
            ];
        }
