...
$this->title = Yii::t('miranda/user', '{permission} Permission Settings', ['permission' => $item->description]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('miranda/user', 'Users'), 'url' => ['/user/default/index']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('miranda/user', 'Permissions'), 'url' => ['/user/role/index']];
    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>
                        ...
                        <?= Yii::t('miranda/user', 'Child permissions') ?>
                    </strong>
                </div>
        ...
        <div class="col-sm-8">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>
                        <span class="glyphicon glyphicon-th"></span><?= Yii::t('miranda/user', 'Routes') ?>
                    </strong>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <input id="search-in-routes" autofocus="on" type="text" class="form-control input-sm"
                                   placeholder="<?= Yii::t('miranda/user', 'Search route') ?>">
                        </div>

                        <!--div class="col-sm-3 text-right">
                            <span id="show-only-selected-routes" class="btn btn-default btn-sm">
				<i class="fa fa-minus"></i> <?= Yii::t('miranda/user', 'Show only selected') ?>
                            </span>
                            <span id="show-all-routes" class="btn btn-default btn-sm hide">
				<i class="fa fa-plus"></i> <?= Yii::t('miranda/user', 'Show all') ?>
                            </span>
                        </div-->
                    </div>
