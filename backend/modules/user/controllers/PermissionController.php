...
use backend\modules\user\models\search\PermissionSearch;
use Yii;
...
class PermissionController extends BaseController
{
     ...
     */
    public $modelSearchClass = 'backend\modules\user\models\search\PermissionSearch';
    ...
    public function actionSetChildRoutes($id)
    {
        ...
        if (($toAdd OR $toRemove) AND ($id == Yii::$app->miranda->commonPermissionName)) {
