...
?>
    ...
    <div class="pull-<?= $position ?> col-lg-<?= $width ?> widget-height-<?= $height ?>">
        <div class="panel panel-default dw-widget">
            <div class="panel-heading"><?= Yii::t('miranda/user', 'Users') ?></div>
            <div class="panel-body">
                    ...
                    <div class="clearfix">
                        <?php foreach ($recent as $item) : ?>
                            <div class="clearfix dw-user">
                                <div class="avatar">
                                    <?php $avatar = ($userAvatar = $item->profile->getAvatarUrl()) ? $userAvatar : $defaultAvatar ?>
                                    <img src="<?= $avatar ?>"/>
                                </div>

                                <div class="dw-user-info">
                                    <div>
                                        <b><?= Yii::t('miranda', 'Login') ?>:</b>
                                        <a class="author"><?= $item->username ?></a>
                                    </div>
                                    <div>
                                        <b><?= Yii::t('miranda', 'E-mail') ?>:</b>
                                        <span><?= $item->email ?></span>
                                    </div>
                                    <div>
                                        <b><?= Yii::t('miranda', 'Data') ?>:</b>
                                        <span><?= "{$item->createdDate} {$item->createdTime}" ?></span>
                                    </div>
                                    <div>
                                        <b><?= Yii::t('miranda', 'Registration IP') ?>:</b>
                ...
                <?php else: ?>
                    <h4><em><?= Yii::t('miranda/user', 'No users found.') ?></em></h4>
                <?php endif; ?>
