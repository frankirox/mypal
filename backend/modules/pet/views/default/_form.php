                        ...
                        <div class="record-info">
                            ...
                            <div class="form-group">
                                <?php if ($model->isNewRecord): ?>
                                    ...
                                    <?= Html::a(Yii::t('miranda', 'Cancel'), ['/pet/default/index'], ['class' => 'btn btn-block btn-default']) ?>
                                <?php else: ?>
                                    ...
                                    <?= Html::a(Yii::t('miranda', 'Close'), ['/pet/default/index'], ['class' => 'btn btn-block btn-default']) ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
