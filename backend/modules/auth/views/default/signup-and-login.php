...
<div class="col-md-6">
    ...
    <div class="box">
        ...
        <p class="text-muted"><?= Yii::t('miranda/frontend',
                'Use your username or email and password to login.'); ?></p>
        ...
        <?= $form->field($logInForm, 'password')->passwordInput([
            'class' => 'form-control traking-input',
            'placeholder' => $logInForm->getAttributeLabel('password'),
            'autocomplete' => 'off'
        ]) ?>

        <p class="text-center">
            <?= Html::submitButton(Yii::t('miranda/auth', '<i class="fa fa-sign-in"></i> Log in'),
                ['class' => 'btn btn-primary btn-lg btn-block', 'id' => 'login']) ?>
        </p>
